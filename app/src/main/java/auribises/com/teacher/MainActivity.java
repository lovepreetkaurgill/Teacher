...
public class MainActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener{
    ...
    void insertIntoDB(){
        ...
        values.put(Util.COL_NAME,teacher.getName());
        values.put(Util.COL_PHONE,teacher.getPhone());
        values.put(Util.COL_EMAIL,teacher.getEmail());
        values.put(Util.COL_GENDER,teacher.getGender());
        values.put(Util.COL_ADDRESS,teacher.getAddress());
        values.put(Util.COL_PURPOSE,teacher.getPurpose());
        values.put(Util.COL_DATE,teacher.getDate());
        values.put(Util.COL_TIME,teacher.getTime());
        values.put(Util.COL_ROOM,teacher.getRoom());
        ...
        if(!updateMode){
            ...
            String where = Util.COL_ID + " = "+rcvTeacher.getId();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == 101){
            Intent i = new Intent(MainActivity.this,AllTeachersActivity.class);
            startActivity(i);
        }
